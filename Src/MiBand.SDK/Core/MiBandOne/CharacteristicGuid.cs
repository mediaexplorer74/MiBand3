...
// Type: MiBand.SDK.Core.MiBandOne.CharacteristicGuid
...
namespace MiBand.SDK.Core.MiBandOne
{
  internal static class CharacteristicGuid
  {
    ...
    public static readonly Guid Notify = new Guid("0000FF03-0000-1000-8000-00805f9b34fb");
    ...
    public static readonly Guid DateTime = new Guid("0000FF0A-0000-1000-8000-00805f9b34fb");
    ...
    public static readonly Guid Sensor = new Guid("0000FF0E-0000-1000-8000-00805f9b34fb");
    public static readonly Guid Paired = new Guid("0000FF0F-0000-1000-8000-00805f9b34fb");
  }
}
