...
// Type: Microsoft.Live.HttpUtility
...
namespace Microsoft.Live
{
  ...
  {
    public static string UrlEncode(string str) => Uri.EscapeDataString(str);

    public static string UrlDecode(string str) => Uri.UnescapeDataString(str);
  }
}
